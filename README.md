...
`collapseObjectsAtPropertyLength`|`integer`|false|When an integer value is assigned, objects will automatically be collapsed by default if the number of properties of that object exceed this value.
