...
import stringifyVariable from '/react/src/js/helpers/stringifyVariable';
...
describe('stringifyVariable', function () {
    ...
    it('stringifyVariable object', function () {
        let test = {a:true};
        expect(
            stringifyVariable(test)
        ).to.equal(JSON.stringify(test, null, '  '));
    });
