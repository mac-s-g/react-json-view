...
export class ExternalPasteIcon extends React.PureComponent {
    render() {
        const { props } = this;
        const { style, ...rest } = props;
        return (
            <span {...rest}>
                <svg
                    {...getIconStyle(style)}
                    width="512.000000pt"
                    height="512.0000000pt"
                    viewBox="0 0 512.000000 512.000000"
                    fill="currentColor"
                    preserveAspectRatio="xMidYMid meet"
                >
                    <g transform="translate(0.00000,512.000000) scale(0.100000,-0.100000)">
                        <path
                            d="M1980 5104 c-64 -23 -125 -68 -158 -117 -33 -46 -62 -124 -62 -162
                l0 -25 -240 0 -240 0 0 -160 0 -160 -288 0 c-305 0 -355 -6 -444 -51 -58 -29
                -140 -110 -171 -167 -60 -111 -57 -9 -57 -1862 0 -1853 -3 -1751 57 -1862 31
                -57 113 -138 171 -167 95 -48 127 -51 604 -51 l448 0 0 -160 0 -160 938 1
                c885 0 936 1 912 17 -14 9 -62 45 -107 80 l-83 62 -750 0 -750 0 0 1760 0
                1760 960 0 960 0 0 -480 0 -480 480 0 480 0 0 -308 0 -308 80 -52 80 -51 0
                442 0 442 -480 480 -480 480 0 125 c0 195 -35 294 -135 389 -115 109 -169 121
                -537 121 l-288 0 0 160 0 160 -239 0 -238 0 -6 45 c-14 101 -87 199 -182 244
                -65 31 -172 38 -235 15z m163 -158 c103 -43 128 -177 48 -257 -65 -65 -157
                -65 -222 0 -124 123 13 325 174 257z m-333 -315 c0 -18 82 -92 132 -118 46
                -24 65 -28 138 -28 73 0 92 4 138 28 50 26 132 100 132 118 0 5 83 9 185 9
                l185 0 0 -160 0 -160 -640 0 -640 0 0 160 0 160 185 0 c102 0 185 -4 185 -9z
                m-530 -391 l0 -80 800 0 800 0 0 80 0 80 283 0 c161 0 298 -4 319 -10 63 -18
                129 -70 162 -130 30 -53 31 -60 34 -197 l4 -143 -1041 0 -1041 0 0 -1680 0
                -1681 -462 3 -463 3 -55 31 c-60 34 -113 100 -130 164 -7 25 -9 601 -8 1741
                l3 1704 31 55 c32 58 99 112 158 129 17 5 160 10 319 10 l287 1 0 -80z m2930
                -995 l365 -365 -368 0 -367 0 0 365 c0 201 1 365 3 365 1 0 166 -164 367 -365z"
                        />
                        <path d="M2240 3120 l0 -80 480 0 480 0 0 80 0 80 -480 0 -480 0 0 -80z" />
                        <path d="M2240 2320 l0 -80 960 0 960 0 0 80 0 80 -960 0 -960 0 0 -80z" />
                        <path
                            d="M3925 2069 c-92 -13 -221 -56 -317 -106 -574 -295 -745 -1035 -359
                -1545 378 -498 1090 -559 1540 -133 422 400 443 1045 46 1464 -238 251 -571
                368 -910 320z m310 -164 c175 -31 336 -115 465 -245 345 -345 345 -895 0
                -1240 -345 -345 -895 -345 -1240 0 -345 345 -345 895 0 1240 206 206 487 295
                775 245z"
                        />
                        <path
                            d="M4020 1294 c-168 -168 -306 -306 -307 -308 -4 -4 -112 -420 -110
                -423 2 -1 97 23 212 53 l210 54 308 308 c295 295 322 327 299 357 -36 47 -273
                265 -288 265 -13 0 -133 -113 -324 -306z m160 -249 l-260 -260 -47 48 -48 47
                260 260 260 260 47 -47 48 -48 -260 -260z"
                        />
                        <path
                            d="M2240 1520 l0 -80 355 0 c330 0 356 1 361 18 4 9 19 45 35 80 l28 62
                -390 0 -389 0 0 -80z"
                        />
                        <path
                            d="M2240 720 l0 -80 354 0 354 0 -19 63 c-10 34 -19 70 -19 80 0 16 -23
                17 -335 17 l-335 0 0 -80z"
                        />
                    </g>
                </svg>
            </span>
...
export class CutIcon extends React.PureComponent {
    render() {
        ...
        return (
            <span>
                ...
                >
                    <g>
                        <path
                            d="M169.941,182.463l125.645,40.038c1.703,0.543,3.566,0.102,4.846-1.145c1.28-1.248,1.767-3.1,1.268-4.816
		...
		C155.816,154.048,155.816,160.444,151.869,164.391z"
                        />
                        <path
                            d="M56.5,264.278H19.904H12.5c-6.903,0-12.5,5.597-12.5,12.5c0,6.903,5.597,12.5,12.5,12.5h7.404H56.5
		c6.903,0,12.5-5.597,12.5-12.5C69,269.875,63.403,264.278,56.5,264.278z"
                        />
                        <path
                            d="M136.732,264.278h-44c-6.903,0-12.5,5.597-12.5,12.5c0,6.903,5.597,12.5,12.5,12.5h44c6.903,0,12.5-5.597,12.5-12.5
		C149.232,269.875,143.635,264.278,136.732,264.278z"
                        />
                        <path
                            d="M216.963,264.278h-44c-6.903,0-12.5,5.597-12.5,12.5c0,6.903,5.597,12.5,12.5,12.5h44c6.903,0,12.5-5.597,12.5-12.5
		C229.463,269.875,223.866,264.278,216.963,264.278z"
                        />
                        <path
                            d="M301.893,265.199c-1.451-0.589-3.035-0.921-4.698-0.921h-44c-6.903,0-12.5,5.597-12.5,12.5c0,6.903,5.597,12.5,12.5,12.5
...
export const Bold = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
...
export const Markdown = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle({ width: "24px", height: "20px" })} viewBox="0 0 24 24">
                <path fill="currentColor" d="M20.56 18H3.44C2.65 18 2 17.37 2 16.59V7.41C2 6.63 2.65 6 3.44 6h17.12c.79 0 1.44.63 1.44 1.41v9.18c0 .78-.65 1.41-1.44 1.41M6.81 15.19v-3.66l1.92 2.35 1.92-2.35v3.66h1.93V8.81h-1.93l-1.92 2.35-1.92-2.35H4.89v6.38h1.92M19.69 12h-1.92V8.81h-1.92V12h-1.93l2.89 3.28L19.69 12z"/>
            </svg>
        </span>
    );
};
...
export const ArrowLeft = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle({ height: "24px", width: "16px" })} viewBox="0 0 24 24">
                <path fill="currentColor" d="M2 12A10 10 0 0112 2a10 10 0 0110 10 10 10 0 01-10 10A10 10 0 012 12m16-1h-8l3.5-3.5-1.42-1.42L6.16 12l5.92 5.92 1.42-1.42L10 13h8v-2z"/>
            </svg>
        </span>
    );
};
...
export const H1 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m11 14v-2h2V6.31l-2.5 1.44V5.44L16 4h2v12h2v2h-6z"/>
            </svg>
        </span>
    );
};
...
export const H2 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m18 14h-6a2 2 0 01-2-2c0-.53.2-1 .54-1.36l4.87-5.23c.37-.36.59-.86.59-1.41a2 2 0 00-2-2 2 2 0 00-2 2h-2a4 4 0 014-4 4 4 0 014 4c0 1.1-.45 2.1-1.17 2.83L15 16h6v2z"/>
            </svg>
        </span>
    );
};
...
export const H3 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m12 0h4a2 2 0 012 2v10a2 2 0 01-2 2h-4a2 2 0 01-2-2v-1h2v1h4v-4h-4v-2h4V6h-4v1h-2V6a2 2 0 012-2z"/>
            </svg>
        </span>
    );
};
...
export const H4 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m15 14v-5h-5v-2l5-7h2v7h1v2h-1v5h-2m0-7V7.42L15.45 11H18z"/>
            </svg>
        </span>
    );
};
...
export const H5 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m12 0h5v2h-5v4h2a4 4 0 014 4 4 4 0 01-4 4h-2a2 2 0 01-2-2v-1h2v1h2a2 2 0 002-2 2 2 0 00-2-2h-2a2 2 0 01-2-2V6a2 2 0 012-2z"/>
            </svg>
        </span>
    );
};
...
export const H6 = (props) => {
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path fill="currentColor" d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m12 0h4a2 2 0 012 2v1h-2V6h-4v4h4a2 2 0 012 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2V6a2 2 0 012-2m0 8v4h4v-4h-4z"/>
            </svg>
        </span>
    );
};
