...
describe("<Index />", function() {
    ...
    it("make sure copy to clipboard is displayed on all properties", function() {
        const { getByText } = render(
            <Index
                value={{
                    test: true,
        ...
        const clipboardIcons = document.querySelectorAll(".copy-to-clipboard-container");

        expect(clipboardIcons).toHaveLength(7)
    })
