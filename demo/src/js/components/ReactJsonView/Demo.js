    ...
    getEditInput = (onEdit) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('onEdit', val)}}
            />
        );
    }
    ...
    getAddInput = (onAdd) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('onAdd', val)}}
            />
        );
    }
    ...
    getDeleteInput = (onDelete) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('onDelete', val)}}
            />
        );
    }
    ...
    getEnableClipboardInput = (enableClipboard) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('enableClipboard', val)}}
            />
        );
    }
    ...
    getObjectSizeInput = (displayObjectSize) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('displayObjectSize', val)}}
            />
        );
    }
    ...
    getDataTypesInput = (displayDataTypes) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('displayDataTypes', val)}}
            />
        );
    }
    ...
    getCollapsedStringsInput = (collapseStringsAfter) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('collapseStringsAfter', val)}}
            />
        );
    }
    ...
    getCollapsedInput = (collapsed) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('collapsed', val)}}
            />
        );
    }
    ...
    getIndentWidthInput = (indentWidth) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('indentWidth', val)}}
            />
        );
    }
    ...
    getThemeInput = (theme) => {
        return (
            <ReactSelect
                ...
                onChange={(val) => {this.set('theme', val)}}
            />
        );
    }
