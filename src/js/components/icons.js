    ...
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path
                    fill="currentColor"
                    d="M13.5 15.5H10v-3h3.5A1.5 1.5 0 0115 14a1.5 1.5 0 01-1.5 1.5m-3.5-9h3A1.5 1.5 0 0114.5 8 1.5 1.5 0 0113 9.5h-3m5.6 1.29c.97-.68 1.65-1.79 1.65-2.79 0-2.26-1.75-4-4-4H7v14h7.04c2.1 0 3.71-1.7 3.71-3.79 0-1.52-.86-2.82-2.15-3.42z"
                />
            </svg>
        </span>
    );
    ...
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path
                    fill="currentColor"
                    d="M7 5h14v2H7V5m0 8v-2h14v2H7M4 4.5A1.5 1.5 0 015.5 6 1.5 1.5 0 014 7.5 1.5 1.5 0 012.5 6 1.5 1.5 0 014 4.5m0 6A1.5 1.5 0 015.5 12 1.5 1.5 0 014 13.5 1.5 1.5 0 012.5 12 1.5 1.5 0 014 10.5M7 19v-2h14v2H7m-3-2.5A1.5 1.5 0 015.5 18 1.5 1.5 0 014 19.5 1.5 1.5 0 012.5 18 1.5 1.5 0 014 16.5z"
                />
            </svg>
        </span>
    );
    ...
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path
                    fill="currentColor"
                    d="M7 13v-2h14v2H7m0 6v-2h14v2H7M7 7V5h14v2H7M3 8V5H2V4h2v4H3m-1 9v-1h3v4H2v-1h2v-.5H3v-1h1V17H2m2.25-7a.75.75 0 01.75.75c0 .2-.08.39-.21.52L3.12 13H5v1H2v-.92L4 11H2v-1h2.25z"
                />
            </svg>
        </span>
    );
...
export const Markdown = props => {
    return (
        <span {...props}>
            <svg
                {...getIconStyle({ width: '24px', height: '20px' })}
                viewBox="0 0 24 24"
            >
                <path
                    fill="currentColor"
                    d="M20.56 18H3.44C2.65 18 2 17.37 2 16.59V7.41C2 6.63 2.65 6 3.44 6h17.12c.79 0 1.44.63 1.44 1.41v9.18c0 .78-.65 1.41-1.44 1.41M6.81 15.19v-3.66l1.92 2.35 1.92-2.35v3.66h1.93V8.81h-1.93l-1.92 2.35-1.92-2.35H4.89v6.38h1.92M19.69 12h-1.92V8.81h-1.92V12h-1.93l2.89 3.28L19.69 12z"
                />
            </svg>
        </span>
    );
...
export const ArrowLeft = props => {
    return (
        <span {...props}>
            <svg
                {...getIconStyle({ height: '24px', width: '16px' })}
                viewBox="0 0 24 24"
            >
                <path
                    fill="currentColor"
    ...
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path
                    fill="currentColor"
                    d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m12 0h5v2h-5v4h2a4 4 0 014 4 4 4 0 01-4 4h-2a2 2 0 01-2-2v-1h2v1h2a2 2 0 002-2 2 2 0 00-2-2h-2a2 2 0 01-2-2V6a2 2 0 012-2z"
                />
            </svg>
        </span>
    );
    ...
    return (
        <span {...props}>
            <svg {...getIconStyle()} viewBox="0 0 24 24">
                <path
                    fill="currentColor"
                    d="M3 4h2v6h4V4h2v14H9v-6H5v6H3V4m12 0h4a2 2 0 012 2v1h-2V6h-4v4h4a2 2 0 012 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2V6a2 2 0 012-2m0 8v4h4v-4h-4z"
                />
            </svg>
        </span>
    );
